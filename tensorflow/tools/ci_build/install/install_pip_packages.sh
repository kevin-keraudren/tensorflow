...
pip3.7 install --upgrade six==1.12.0
pip2 install "future>=0.17.1"
pip3.7 install "future>=0.17.1"
...
pip3.7 install --upgrade werkzeug==0.11.10

# Install bleach. html5lib will be picked up as a dependency.
pip2 install --upgrade bleach==2.0.0
pip3.7 install --upgrade bleach==2.0.0

# Install markdown.
pip2 install --upgrade markdown==2.6.8
pip3.7 install --upgrade markdown==2.6.8

# Install protobuf.
pip2 install --upgrade protobuf==3.6.1
pip3.7 install --upgrade protobuf==3.6.1

# Remove obsolete version of six, which can sometimes confuse virtualenv.
rm -rf /usr/lib/python3.7/dist-packages/six*
...
if $(cat /etc/*-release | grep -q 14.04); then
  ...
  pip3.7 install --no-binary=:all: --upgrade numpy==1.19.2
else
  pip2 install --upgrade numpy==1.14.5
  pip3.7 install --upgrade numpy==1.19.2
fi

pip2 install scipy==1.2.2
pip3.7 install scipy==1.4.1
...
pip3.7 install pandas==1.2.1

# Benchmark tests require the following:
pip2 install psutil
pip3.7 install psutil
pip2 install py-cpuinfo
pip3.7 install py-cpuinfo
...
pip3.7 install lazy-object-proxy==1.4.3
...
pip3.7 install tf-estimator-nightly --no-deps

# Tensorboard
pip2 install tb-nightly --no-deps
pip3.7 install tb-nightly --no-deps

# Argparse
pip2 install --upgrade argparse
pip3.7 install --upgrade argparse

# tree
pip2 install dm-tree
pip3.7 install dm-tree

# tf.distribute multi worker tests require the following:
# Those tests are Python3 only.
pip3.7 install --upgrade dill
pip3.7 install --upgrade tblib
